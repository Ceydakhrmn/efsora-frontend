export const en = {
  ...
  bulkImport: {
    ...
    description: 'Upload users in bulk from a CSV file',
    ...
    message: 'Message',
    templateHint: 'CSV header: firstName, lastName, email, password, department, role. Default password is "Efsora123!" if left empty.',
    importUsers: 'CSV Import',
  },
}
