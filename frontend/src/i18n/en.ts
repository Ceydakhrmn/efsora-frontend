export const en = {
  ...
  auth: {
    ...
    loginWithAuthenticator: 'Login with Authenticator',
  ...
  users: {
    ...
    inviteVerifying: 'Verifying invite...',
    inviteCreateAccount: 'Create Your Account',
    inviteEnterDetailsFor: 'Enter your details for',
    inviteFirstNameRequired: 'First name and last name are required',
    invitePasswordMinLength: 'Password must be at least 6 characters',
    invitePasswordsMismatch: 'Passwords do not match',
    inviteRegistrationError: 'An error occurred during registration',
    inviteCreating: 'Creating...',
    inviteCreateButton: 'Create Account',
    invitePasswordPlaceholder: 'At least 6 characters',
    invitePasswordConfirmPlaceholder: 'Enter your password again',
  },
  assets: {
  ...
  activityLog: {
    ...
    savedFilterPrompt: 'Enter filter name',
    savedFilterDefaultName: 'New Filter',
